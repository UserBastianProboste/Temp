    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('jefe_directo', models.CharField(blank=True, max_length=50, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rol', models.CharField(choices=[('estudiante', 'Estudiante'), ('coordinador', 'Coordinador')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('tipo_practica', models.CharField(choices=[('practica_1', 'Practica I'), ('practica_2', 'Practica iI')], default='practica_1', max_length=20)),
                ('fecha_inicio', models.DateField()),
                ('fecha_termino', models.DateField()),
                ('horario_trabajo', models.CharField(blank=True, max_length=100, null=True)),
                ('horario_colacion', models.CharField(blank=True, max_length=100, null=True)),
                ('cargo_desarrollar', models.CharField(blank=True, max_length=100, null=True)),
                ...
                ('empresa', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='internships.empresa')),
